...
// g++ generateDataPlants.cpp -o generateDataPlants.out -I ../../../../ -I ../../../ --std=c++2a
...
int main (int argc, char **argv) {
   ...
   ofstream mapFile (*currentPath + "/numberPlantMap.txt");
   ofstream answerFile (*currentPath + "/plantAnswerFile.txt");
